<script>
  ...
  const projectData = {
    ...
    "I-Love-Web": {
      ...
      summary: "I Love Web is my personal digital garden where I collect experiments, ideas, and discoveries related to web development. It serves as a playground for exploring new technologies while documenting my learning journey.",
      challenge: "Many personal projects become difficult to maintain as content grows. The challenge was to create a flexible platform that could continuously evolve without becoming cluttered or difficult to navigate.",
      solution: "Using SvelteKit and Markdown, I built a scalable content system organized around topics rather than publication dates. Combined with subtle animations and smooth transitions, the platform encourages exploration while remaining lightweight, maintainable, and easy to expand.",
    ...
    "we-love-web": {
      ...
      summary: "We Love Web is a blog platform where I document insights, lessons, and inspiration gathered from guest speakers and industry professionals during my studies at FDND. The project transforms scattered notes into a structured and enjoyable reading experience.",
      challenge: "The original notes existed as standalone Markdown files and were difficult to revisit or browse. The challenge was to turn these disconnected notes into a platform that encourages exploration, learning, and long-term knowledge retention.",
      solution: "I created a clean editorial-style blog using SvelteKit and Markdown, focusing on readability, navigation, and content discoverability. Smooth page transitions and a reusable content structure make it easy to publish new articles while providing visitors with an enjoyable reading experience.",
    ...
    "De-Koperen-Kat": {
      ...
      summary: "For my graduation project, I redesigned and rebuilt the website of De Koperen Kat, a local brewery in Woerden. The project focused on improving the user experience, making information easier to find, and creating a modern digital presence that better reflects the brewery's identity.",
      challenge: "The existing website suffered from unclear navigation and a confusing information structure, making it difficult for visitors to find upcoming events, opening hours, and information about the brewery. The challenge was to simplify the user journey while maintaining the brewery's unique character.",
      solution: "Through user research, competitor analysis, and usability testing, I redesigned the information architecture and created a more intuitive navigation structure. Built with SvelteKit and Supabase, the new website helps visitors find important information faster while using subtle GSAP animations to create a more engaging experience without sacrificing performance or accessibility.",
